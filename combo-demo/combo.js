...
// Storage keys — namespaced so the demo never touches the main app's data
const COMBO_WANTED_KEY = 'combo_demo_wanted_courses';
const COMBO_PASSED_KEY = 'combo_demo_passed_courses';
