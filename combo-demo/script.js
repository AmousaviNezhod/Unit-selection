...
const CONFIG = {
    ...
    // LocalStorage keys — namespaced so the demo never touches the main app
    STORAGE_KEY: 'combo_demo_selected_courses',
    CUSTOM_DATA_KEY: 'combo_demo_custom_data',
    DEGREE_KEY: 'combo_demo_degree',
